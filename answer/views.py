...
StatAge20to30Bank = list(Banks.objects.values_list('bank_name', flat=True).filter(bank_id = list(StatisticAge2.objects.all())[1].m20_30)).encode('utf-8')
StatAge20to30Bank = list(Banks.objects.values_list('bank_name', flat=True).filter(bank_id = list(StatisticAge2.objects.all())[1].m30_40)).encode('utf-8')
