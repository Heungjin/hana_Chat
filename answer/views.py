...
def message(request):
    ...
    # 하나은행
        ...
        result_bank1 = list(LoanGoods.objects.values_list('loan_good_name', flat=True).filter(loan_bank_id=1).filter(money_credit_line__gte = result_loan).order_by('avg_int_rat'))[0]
